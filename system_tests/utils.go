...
func publishToNewQueue(rabbitmqHostName, rabbitmqPort, rabbitmqUsername, rabbitmqPassword string) error {
...
func publishToNewQueueAMQPS(message, username, password, hostname, amqpsPort, caFilePath string) error {
	// create connection
